...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m16(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'descriptionField': 'Descrição', 'endValueField': 'Valor Final', 'startValueField': 'Valor Inicial', 'currentValueField': 'Valor Corrente', 'decimalsNumberField': 'Número de Decimais', 'measureUnitField': 'Unidade', 'metricField': 'Métrica', 'other': 'Não Definido', })}";
  ...
  static m22(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'symbolField': 'Símbolo', 'other': 'Não Definido', })}";
  ...
  static m25(fieldName) => "${Intl.select(fieldName, {'domainField': 'Domínio', 'other': 'Não Definido', })}";
  ...
  static m27(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'codeField': 'CNPJ', 'other': 'Não Definido', })}";
  ...
  static m31(functionName) => "${Intl.select(functionName, {'create': 'Criado(a)', 'update': 'Atualizado(a)', 'delete': 'Deletado(a)', 'read': 'Lido(a)', 'other': 'Não Definido', })}";
  ...
  static m33(fieldName) => "${Intl.select(fieldName, {'organizationField': 'Organização', 'accessRoleField': 'Papel de Acesso', 'other': 'Não Definido', })}";
  ...
  static m41(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'descriptionField': 'Descrição', 'groupField': 'Grupo', 'leaderField': 'Líder', 'workStagesField': 'Estágios', 'objectiveField': 'Objetivo', 'other': 'Não Definido', })}";

  static m42(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'descriptionField': 'Descrição', 'dueDateField': 'Data Limite', 'completedField': 'Concluído', 'workStageField': 'Estágio', 'assignedToField': 'Atribuído para', 'attachmentsField': 'Anexos', 'checkItemsField': 'Itens de Checagem', 'other': 'Não Definido', })}";
  ...
  static m45(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'stateField': 'Estado', 'other': 'Não Definido', })}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "AuthMsg_passwordNotSavedMsg" : MessageLookupByLibrary.simpleMessage("Senha não salva."),
    ...
    "MailMsg_InformIt" : MessageLookupByLibrary.simpleMessage("Informe ela no Auge"),
    "MailMsg_subjectNewPasswordRequired" : MessageLookupByLibrary.simpleMessage("Nova Senha Solicitada."),
    "MailMsg_toDefineNewPasswordInformTheCode" : MessageLookupByLibrary.simpleMessage("Para definir a nova senha informe o código"),
    "MailMsg_viewOrReplyIt" : MessageLookupByLibrary.simpleMessage("Veja ou responda ele no Auge"),
    "MailMsg_youIsReceivingThisEMailBecauseNewPasswordWasRequired" : MessageLookupByLibrary.simpleMessage("Você está recebendo este e-mail porque uma nova senha foi solicitada. Ignore este e-mail se você não solicitou uma nova senha."),
