...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(className) => "${Intl.select(className, {'className': 'Item de Trabalho', 'other': 'Não Definido', })}";
  ...
  static m7(label) => "${Intl.select(label, {'configurationLabel': 'Configuração', 'serverAndAdminLabel': 'Servidor e Admin', 'groupLabel': 'Grupo', 'synchronizationLabel': 'Sincronização', 'generalLabel': 'Geral', 'directoryServiceLabel': 'Serviço de Diretório', 'testConnectionLabel': 'Testar Conexão', 'syncAndSaveLabel': 'Sincronizar e Salvar', 'other': 'Não Definido', })}";

  static m8(label) => "${Intl.select(label, {'baseLevel': 'Nível base', 'oneLevel': 'Nível Um', 'subLevel': 'Sub Nível', 'subordinateSubtree': 'Subarvore Subordinada', 'other': 'Não Definido', })}";

  static m9(label) => "${Intl.select(label, {'finished': 'Finalizado.', 'errorException': 'Uma exceção ocorreu.', 'errorEmailAttributeNotFound': 'Atributo de email não encontrado.', 'errorFirstNameAttributeNotFound': 'Atributo de primeiro nome não encontrado.', 'errorGroupOrGroupMemberNotFound': 'Grupo ou membro do grupo não econtrado.', 'errorGroupFilterInvalid': 'Filtro do grupo inválido.', 'errorLastNameAttributeNotFound': 'Atributo do último nome não encontrado.', 'errorIdentificationAttributeNotFound': 'Atributo de identificação (logar) não encontrado.', 'errorUserAttributeForGroupRelationshipNotFound': 'Atributo de usuário para relacionamento com o grupo não encontrado.', 'errorNotBoundInvalidCredentials': 'Não associado. Credencial inválida.', 'errorNotConnected': 'Não conectado.', 'errorUserNotFound': 'Usuário não encontrado.', 'other': 'Não Definido', })}";

  static m10(label) => "${Intl.select(label, {'objectivesGanttLabel': 'Gantt de Objetivos', 'other': 'Não Definido', })}";

  static m11(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'inactiveField': 'Inativo', 'leaderField': 'Líder', 'groupTypeField': 'Tipo do Grupo', 'superGroupField': 'Super Grupo', 'membersField': 'Membros', })}";
  ...
  static m14(label) => "${Intl.select(label, {'insightsLabel': 'Insights', 'groupLabel': 'Grupo', 'leaderLabel': 'Lider', 'objectivesOverallLabel': 'Objetivos no Geral', 'objectivesMeasuresLabel': 'Objetivos e Medidas', 'worksWorkItemsLabel': 'Trabalhos e Itens de Trabalho', 'objectivesLabel': 'Objetivos', 'objectivesDescriptionLabel': 'Número total de objetivos', 'objectivesAchievedLabel': 'Objetivos Alcançados', 'measuresAchievedDescriptionLabel': 'Medidas acima de 70% de progresso', 'objectivesRequiringAttentionLabel': 'Objetivos Requerendo Atenção', 'measuresRequiringAttentionDescriptionLabel': 'Medidas abaixo de 30% de progresso', 'measuresLabel': 'Medidas', 'measuresDescriptionLabel': 'Número total de medidas', 'measuresAchievedLabel': 'Medidas Alcançadas', 'measuresRequiringAttentionLabel': 'Medidas Requerendo Atenção', 'worksLabel': 'Trabalhos', 'worksDescriptionLabel': 'Número total de trabalhos', 'worksCompletedLabel': 'Trabalhos Finalizados', 'worksCompletedDescriptionLabel': 'Trabalhos com 100% dos itens de trabalho finalizados', 'worksRequiringAttentionLabel': 'Trabalhos Requerendo Atenção', 'worksRequiringAttentionDescriptionLabel': 'Trabalhos com itens de trabalho atrasados', 'workItemsLabel': 'Itens de Trabalho', 'workItemsDescriptionLabel': 'Número total de items de trabalho', 'workItemsCompletedLabel': 'Items de Trabalho Finalizados', 'workItemsCompletedDescriptionLabel': 'Itens de Trabalho com 100% de progresso', 'workItemsRequiringAttentionLabel': 'Itens de Trabalho Requerendo Atenção', 'workItemsRequiringAttentionDescriptionLabel': 'Itens de trabalho atrasados', 'other': 'Não Definido', })}";

  static m15(label) => "${Intl.select(label, {'objectivesMapLabel': 'Mapa de Objetivos', 'other': 'Não Definido', })}";

  static m16(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'descriptionField': 'Descrição', 'endValueField': 'Valor Final', 'startValueField': 'Valor Inicial', 'currentValueField': 'Valor Corrente', 'decimalsNumberField': 'Número de Decimais', 'measureUnitField': 'Unidade', 'metricField': 'Métrica', })}";
  ...
  static m18(label) => "${Intl.select(label, {'measuresLabel': 'Medidas', 'editMeasureLabel': 'Editar Medida', 'addMeasureLabel': 'Adicionar Medida', 'progressLabel': 'Progresso', 'startValueLabel': 'Valor Inicial', 'currentValueLabel': 'Valor Corrente', 'endValueLabel': 'Valor Final', 'other': 'Não Definido', })}";

  static m19(label) => "${Intl.select(label, {'percentLabel': 'Percentual', 'moneyLabel': 'Monetário', 'indexLabel': 'Índice', 'unitaryLabel': 'Unitário', })}";

  static m20(fieldName) => "${Intl.select(fieldName, {'dateField': 'Data', 'currentValueField': 'Valor Corrente', 'commentField': 'Comentário', })}";

  static m21(label) => "${Intl.select(label, {'measureProgressLabel': 'Progresso da Medida', 'progressCurrentValuesLabel': 'Valores do Progresso Corrente', 'other': 'Não Definido', })}";
  ...
  static m30(label) => "${Intl.select(label, {'notStarted': 'Não Iniciado', 'inProgress': 'Em Progresso', 'completed': 'Finalizado', 'other': 'Não Definido', })}";

  static m31(functionName) => "${Intl.select(functionName, {'create': 'Criado', 'update': 'Atualizado', 'delete': 'Deletado', 'read': 'Lido', 'other': 'Não Definido', })}";

  static m32(fieldName) => "${Intl.select(fieldName, {'timelineLabel': 'Linha do tempo', 'dayAgoLabel': 'dia atrás', 'daysAgoLabel': 'dias atrás', 'hourAgoLabel': 'hora atrás', 'hoursAgoLabel': 'horas atrás', 'minuteAgoLabel': 'minuto atrás', 'minutesAgoLabel': 'minutos atrás', 'secondAgoLabel': 'segundo atrás', 'secondsAgoLabel': 'segundos atrás', 'valueLabel': 'valor', 'theLabel': 'o', 'changedFromLabel': 'alterado de', 'wasLabel': 'era', 'other': 'Não Definido', })}";

  static m33(fieldName) => "${Intl.select(fieldName, {'organizationField': 'Organização', 'accessRoleField': 'Papel de Acesso', })}";
  ...
  static m41(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'descriptionField': 'Descrição', 'groupField': 'Grupo', 'leaderField': 'Líder', 'workStagesField': 'Estágios', 'objectiveField': 'Objetivo', })}";

  static m42(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'descriptionField': 'Descrição', 'dueDateField': 'Data Limite', 'completedField': 'Finalizado', 'workStageField': 'Estágio', 'assignedToField': 'Atribuído para', 'attachmentsField': 'Anexos', 'checkItemsField': 'Itens de Checagem', })}";

  static m43(label) => "${Intl.select(label, {'workKanbanLabel': 'Trabalho Kanban', 'workItemsLabel': 'Itens de Trabalho', 'editWorkItemLabel': 'Editar Itens de Trabalho', 'addWorkItemLabel': 'Adicionar Item de Trabalho', 'selectAValueLabel': 'Selecionar um Valor', 'workItemsOverDueLabel': 'Itens de Trabalho Atrasados', 'checkItemLabel': 'Item de Checagem', 'noMatchLabel': 'Sem Correspondência', 'dropFileHereLabel': 'Soltar Arquivo Aqui', 'other': 'Não Definido', })}";

  static m44(label) => "${Intl.select(label, {'worksLabel': 'Trabalhos', 'sortedByLabel': 'Ordenar Por', 'editWorkLabel': 'Editar Trabalho', 'addWorkLabel': 'Adicionar Trabalho', 'objectiveLabel': 'Objetivo', 'workItemsOverDueLabel': 'Itens de Trabalho Atrasados', 'noMatchLabel': 'Sem Correspondência', 'selectLabel': 'Selecionar', 'filterWorksLabel': 'Filtar Trabalhos', 'other': 'Não Definido', })}";

  static m45(fieldName) => "${Intl.select(fieldName, {'nameField': 'Nome', 'stateField': 'Estado', })}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static _notInlinedMessages(_) => <String, Function> {
    "AppLayoutMsg_label" : m0,
    "AuthMsg_browserCompatibleErrorMsg" : MessageLookupByLibrary.simpleMessage("Browser Compatível: Chrome"),
    ...
    "AuthMsg_label" : m1,
    "AuthMsg_organizationNotFoundMsg" : MessageLookupByLibrary.simpleMessage("Uma organização para conta de usuário não foi encontrada."),
    "AuthMsg_serverApiErrorMsg" : MessageLookupByLibrary.simpleMessage("Servidor não disponível."),
    "AuthMsg_userNotFoundMsg" : MessageLookupByLibrary.simpleMessage("Conta de usuário não encontrada para identificação e senha informada."),
    "ClassNameMsg_label" : m2,
    "CommonFieldAndValuesMsg_labelAndValue" : m3,
    "CommonMsg_buttonLabel" : m4,
    "CommonMsg_label" : m5,
    "CommonMsg_requiredValueMsg" : MessageLookupByLibrary.simpleMessage("Entre com o valor requerido."),
    ...
    "MailMsg_viewOrReplyIt" : MessageLookupByLibrary.simpleMessage("Veja ou responda ele no Auge"),
    "MailMsg_youIsReceivingThisEMailBecauseYouIsThe" : MessageLookupByLibrary.simpleMessage("Você está recebendo este e-mail porque você é"),
    "MapMsg_label" : m15,
    "MapMsg_notInformedMsg" : MessageLookupByLibrary.simpleMessage("Não Informado!"),
